            ...
            <!-- =================== ADMINISTRATION (HEADMASTER ONLY) =================== -->
                <div class="nav-section">
                    ...
                    <div class="nav-group">
                        ...
                        <div class="nav-group-content">
                            <a href="teacher_management_unified.php"
                               class="nav-subitem <?php echo basename($_SERVER['PHP_SELF']) == 'teacher_management_unified.php' ? 'active' : ''; ?>">
                    ...
                    <!-- Student Management (Moved here) -->
                    <div class="nav-group">
                        <a href="student_management_unified.php"
                           class="nav-item <?php echo basename($_SERVER['PHP_SELF']) == 'student_management_unified.php' ? 'active' : ''; ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z" />
                            </svg>
