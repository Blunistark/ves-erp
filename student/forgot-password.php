...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!isset($_POST['csrf_token']) || !validateCSRFToken($_POST['csrf_token'])) {
        ...
        $sql = "SELECT id, email, full_name FROM users WHERE email = ? AND role = 'student' AND status = 'active'";
        ...
        if (!empty($result)) {
            ...
            if ($insertResult !== false) {
                ...
                $resetLink = "http://{$_SERVER['HTTP_HOST']}/ves/student/reset-password.php?token=" . $token;
