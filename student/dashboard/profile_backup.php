        ...
        <div class="profile-container">
            ...
            <div class="profile-card" style="margin-bottom: 2rem;">
                <div class="profile-header" style="text-align: center; padding: 2rem;">
                    <div class="profile-pic" style="margin: 0 auto 1.5rem;">
                        <img src="<?php echo $photo_url; ?>" alt="Student Profile" style="width: 120px; height: 120px; border-radius: 50%; object-fit: cover; border: 4px solid #e2e8f0;">
                    </div>
                    <h2 class="profile-name" style="margin-bottom: 0.5rem; color: #1e293b;"><?php echo safeDisplay($student['full_name']); ?></h2>
                    <p class="profile-role" style="color: #64748b; margin-bottom: 0.5rem;">Student • <?php echo safeDisplay($student['class_name'] . ' - ' . $student['section_name']); ?></p>
