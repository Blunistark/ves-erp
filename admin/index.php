...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!isset($_POST['csrf_token']) || !validateCSRFToken($_POST['csrf_token'])) {
        ...
        $user = authenticateUser($email, $password, 'admin');
...
<head>
    ...
    <title>Admin Login - Vinodh English School</title>
    ...
    <div class="main-container">
        ...
        <div class="login-section">
            <div class="login-form">
                ...
                <p class="form-subtitle">Please enter your credentials to access the admin panel</p>
                ...
                <form id="loginForm" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                    ...
                    <button type="button" onclick="goBack()" class="google-btn">Go Back</button>
                </form>
