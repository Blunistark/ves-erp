...
CREATE TABLE visitors (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    reporting_person VARCHAR(255) NULL,
...
INSERT INTO visitors (visitor_name, email, phone_number, purpose, visit_date, created_by, reporting_person) VALUES
('Ethan Harper', 'ethan.harper@email.com', '555-123-4567', 'Tour', '2024-07-26 10:00:00', 1, 'Principal'),
('Noah Carter', 'noah.carter@email.com', '555-246-8013', 'Meeting', '2024-07-24 11:30:00', 1, 'Secretary'),
('Liam Evans', 'liam.evans@email.com', '555-789-0123', 'Interview', '2024-07-22 14:00:00', 1, 'HM'),
('Jackson Green', 'jackson.green@email.com', '555-654-3210', 'Event', '2024-07-20 15:45:00', 1, 'Teacher'),
('Aiden Ingram', 'aiden.ingram@email.com', '555-987-1234', 'Consultation', '2024-07-18 09:15:00', 1, 'Admin');